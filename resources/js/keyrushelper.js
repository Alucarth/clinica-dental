    ...
    var image4 = new Image();
        ...
        switch(diente['mesial'])
        {
          case "0":  image4.src = '../../images/pieza/1.png';
                break;
          case "1":  image4.src = '../../images/pieza/1r.png';//dependiendo el conexto se tiene que agregar un nuevo path
                break;
        }
        // image.src = '../../images/pieza/5.png';
        // image1.src = '../../images/pieza/4.png';
...
module.exports ={DibujarDiente,DibujarDienteRojo};
